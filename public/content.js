...
if (window.aiWebAgentContentScriptLoaded) {
  console.log('Content script already loaded, skipping...');
} else {
  window.aiWebAgentContentScriptLoaded = true;

// ตรวจสอบว่า ContentDOMUtils ถูกประกาศแล้วหรือไม่
if (typeof window.ContentDOMUtils === 'undefined') {
...
// ตรวจสอบว่า ContentCommandHandler ถูกประกาศแล้วหรือไม่
if (typeof window.ContentCommandHandler === 'undefined') {
...
if (typeof chrome !== 'undefined' && chrome.runtime && chrome.runtime.onMessage) {
  if (!window.chromeMessageListenerAdded) {
    window.chromeMessageListenerAdded = true;
